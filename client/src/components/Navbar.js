...
function Navbar() {
  ...
  return (
    <nav className="navbar">
      ...
      <div className="navbar_search" ref={inputRef}>
        ...
        {showInput ? (
          ...
          <span onClick={() => setShowInput(!showInput)}>Search</span>
        )}
        {searchText ? (
          <i className="material-icons" onClick={() => setSearchText("")}>
            clear
          </i>
        ) : null}
      </div>
      <div className="navbar_links">
        ...
        <div>
          ...
          >
            <img
              src="https://images.unsplash.com/photo-1609533676311-0da452fda608?ixid=MXwxMjA3fDB8MHx0b3BpYy1mZWVkfDF8dG93SlpGc2twR2d8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=60"
              alt="profile_pic"
          ...
          >
            ...
            >
              ...
              <Link to="/saved" className="nav_popover_items_items">
                <svg
                  aria-label="Saved"
                  className="_8-yf5 "
                  fill="#262626"
              ...
              <Link to="switch-accounts" className="nav_popover_items_items">
                <svg
